...
* L'ensemble des méthodes appliquées permettent d'obtenir une suite conséquente de tests, même si c'est laborieux et conséquent. Il y'a presque autant de code pour les tests que pour le logiciel.

* Aucun code n'est digne de confiance absolue, même celui d'un ou plusieurs enseignants.
