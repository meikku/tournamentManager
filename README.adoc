...
For example, here is the same tournament but with all games completed, and with in green the history of _p2_'s results (who is the winner of the tournament):
